...
Największym problemem algorytmu $k$-średnich jest dobór początkowego podziału na grupy. Możliwymi sposobami są losowy wybór $k$ przykładów ze zbioru danych lub ręczne podanie zbioru centroidów początkowych.
